...
import { CUSTOM_ELEMENTS_SCHEMA, Component, EventEmitter, OnChanges, OnDestroy, OnInit } from '@angular/core';
...
export class AcphComponent implements OnDestroy, OnInit {
  ...
  instance?: CustomerDetailsComponent;
  ...
  show() {
    ...
    this.instance = dialogRef!.instance.componentRef!.instance as CustomerDetailsComponent;
    this.instance.oneventFire.subscribe((e) => { this.ref?.close(e) });
  ...
  ngOnDestroy() {
    ...
    this.instance?.oneventFire.unsubscribe();
  }
