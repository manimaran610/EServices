export class GradientConfig {
  ...
  static header_back_color = 'header-info'; // header-blue, header-red, header-purple, header-info, header-dark, header-orange, header-green, header-yellow, header-orchidGreen, header-indigoGreen, header-darkGreen, header-darkblue
