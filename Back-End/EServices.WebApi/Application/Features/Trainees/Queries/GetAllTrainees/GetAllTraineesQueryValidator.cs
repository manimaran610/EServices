...
{
    public class GetAllTraineesQueryValidator : RequestParamererValidator<GetAllTraineesQuery>
    {
            public GetAllTraineesQueryValidator(){
        ...
        {
            return new Trainee().GetType().GetProperties().Any(e => string.Equals(e.Name, fieldName, System.StringComparison.OrdinalIgnoreCase));
        }
    }
}