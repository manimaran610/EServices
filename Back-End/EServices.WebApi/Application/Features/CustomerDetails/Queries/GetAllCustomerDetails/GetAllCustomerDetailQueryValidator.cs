...
{
    public class GetAllCustomerDetailsQueryValidator : RequestParamererValidator<GetAllCustomerDetailsQuery>
    {
        
        public GetAllCustomerDetailsQueryValidator(){
        ...
        {
            return new CustomerDetail().GetType().GetProperties().Any(e => string.Equals(e.Name, fieldName, System.StringComparison.OrdinalIgnoreCase));
        }
    }
}